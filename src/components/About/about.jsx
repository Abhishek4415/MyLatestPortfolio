...
import idcard from "../../assets/idcard/idcard1.png"
//#585956
//#ececec
  ...
  return (
    <section id="about" className='flex-row md:flex justify-around '>
      ...
      <div className='md:w-[35%] md:py-60 ml-10 mr-10 py-30 md:ml-30'>
        ...
        <p className='leading-7 text-gray-300'>I am a Computer Science student and full-stack developer from Bihar, India. I build scalable, user-focused applications with React, Node.js, Express, MongoDB, and AI APIs. I also have hands-on experience evaluating and improving LLM responses.
        </p>
        {/* resume  */}
        <a href="https://drive.google.com/file/d/1gxzSYBDaOlv8A7YzaxG1O0O_GFNMXvLi/view?usp=sharing"
        target='_blank'
